...
void jacobian_comparison() {
    ...
    auto const_rect_histo = get_histogram("const_rect", 20, markers[2u], dummy);
    ...
    auto helix_rect_histo = get_histogram("helix_rect", 20, markers[3u], dummy);
    ...
    auto const_wire_histo = get_histogram("const_wire", 20, markers[2u], dummy);
    ...
    auto helix_wire_histo = get_histogram("helix_wire", 20, markers[3u], dummy);
