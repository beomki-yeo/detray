...
void propagator_test(
    typename detector_t::detector_view_type, covfie::field_view<bfield_bknd_t>,
...
inline auto run_propagation_device(
    ...
    typename detector_t::detector_view_type det_view,
    covfie::field_view<bfield_bknd_t> field_view, dvector<track_t> &tracks,
    ...
    propagator_test<bfield_bknd_t, detector_t>(
        det_view, field_view, tracks_data, candidates_buffer,
...
inline auto run_propagation_test(
    ...
    auto &&[device_path_lengths, device_positions, device_jac_transports] =
        run_propagation_device<bfield_bknd_t>(mr, det, det_view, field,
