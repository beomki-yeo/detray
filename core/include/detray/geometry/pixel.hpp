...
class pixel final : public geometry_unit<2, scalar_t, material_t> {

    public:
    using base_type = geometry_unit<2, scalar_t, material_t>;
    ...
    pixel(const mask_type& mask, const material_structure_type& slab)
